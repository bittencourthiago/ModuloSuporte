...
extension FavoritosViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        vcDetails.abreDetalhes(initials: "BTC", currentValueOFCoin: "31,010.20", isFavorite: false, hourSell: "310,010.20", daySell: "1,310.010.20", monthSell: "100,310.010.20", image: UIImage())
